...
module.exports = class AddDefaultUsers1710017675468 {
  async up(queryRunner) {
    ...
    await queryRunner.query(
      `INSERT INTO "user" 
            ("id", "email", "password", "isAdmin", "profilePicture") VALUES ("1", "${DEFAULT_ADMIN_EMAIL}", "${hashedAdminPassword}", TRUE, "../assets/profile/yoda.png"), ("2", "${DEFAULT_USER_EMAIL}", "${hashedUserPassword}", FALSE, "../assets/profile/yoda.png")`,
    );
  }
